...
SELECT interaction_durations_id.id, interaction_durations_id.track_id,interaction_durations_id.ts, interaction_durations_id.dur, interaction_durations_id.interaction_id, interaction_durations_type.interaction_type, SUM(interaction_durations_id.dur) as "processing time" FROM interaction_durations_id
